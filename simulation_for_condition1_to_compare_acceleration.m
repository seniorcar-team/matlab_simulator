function acceleration_array = simulation_for_condition1_to_compare_acceleration(Pedestrian,file_num)
%% simulationの実行
...
file_name_first_position_ped = ['pedestrian_first_state_condition1_',file_num_str];
...
filename = ['seniorcar_state_condition1_',file_num_str];
