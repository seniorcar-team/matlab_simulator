...
global maximum_deceleration; maximum_deceleration = 1.5; %最高減速度[m/s2]
global vision_distance_ped;vision_distance_ped = 10; %視野距離[m]
global vision_distance_senior;vision_distance_senior = 10; %視野距離[m]
global safety_margin_front; safety_margin_front = 0.30; %安全幅前方[m]
global safety_margin_rear; safety_margin_rear = 0.10; %安全幅後方[m]
global safety_margin_side; safety_margin_side = 0.10; %安全幅左右[m]
global margin_time; margin_time = 0.1; %余裕時間
global safety_speed; safety_speed = 3.5/3.6; %安全速度[m/s]
global pedestrian_velocity; pedestrian_velocity = 1.7;
global safety_space; safety_space = 0.42; %安全距離[m]
...
%評価関数の係数α，β，Γ，θ_max，κ_max,予測時間(2s)（θとκは後で何種類か試すために今は0を入れている）
%PARAM = [0.15,0.25,0.1,0,0,2.0];引数に入れた201810142030
