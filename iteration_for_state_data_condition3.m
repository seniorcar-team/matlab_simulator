...
for i = 1:100
    file_name_pre = 'seniorcar_state_condition3_10_';
...
save('condition3_10_state_data_matrix','state_data_matrix_10','-ascii');
for i = 1:100
...
save('condition3_20_state_data_matrix','state_data_matrix_20','-ascii');
for i = 1:100
...
save('condition3_40_state_data_matrix','state_data_matrix_40','-ascii');