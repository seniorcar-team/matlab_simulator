function [] = iteration_simulation_for_condition3()
...
for i = 37:37
    ...
    if rem(i,3) == 1
        emergency_array = simulation_for_condition3(Pedestrian,file_tag);
...
save('emergency_counter_array_condition3_','emergency_counter_array','-ascii')