function path_array = state_lattice_motion_planner_for_c2_c4(x,existence_prohability_distribution_all,goal,predict_obserbable_pedestrian_position,time,Pedestrian)
path_array = NaN;
