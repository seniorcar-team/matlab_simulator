...
for i = 3:4
    ...
    B = load(filename);
    filename = [filename_pre,'condition1_',ped_num_str,'_',file_number_str];
...
file_name_for_comfort_indicator = 'condition1_comfort_indicator_10';
save(file_name_for_comfort_indicator,'comfort_indicator_matrix_ped_num10','-ascii');

file_name_for_comfort_indicator = 'condition1_comfort_indicator_20';
save(file_name_for_comfort_indicator,'comfort_indicator_matrix_ped_num20','-ascii');

file_name_for_comfort_indicator = 'condition1_comfort_indicator_40';
