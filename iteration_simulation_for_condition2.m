function [] = iteration_simulation_for_condition2()
...
for i = 45:45
    ...
    if rem(i,3) == 1
        emergency_array = simulation_for_condition2(Pedestrian,file_tag);
...
save('emergency_counter_array_condition2_','emergency_counter_array','-ascii')