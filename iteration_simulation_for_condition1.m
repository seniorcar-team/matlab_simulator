function [] = iteration_simulation_for_condition1()
...
for i = 1:300
    ...
    if rem(i,3) == 1
        emergency_array = simulation_for_condition1(Pedestrian,file_tag);
...
save('emergency_counter_array_condition1_','emergency_counter_array','-ascii')