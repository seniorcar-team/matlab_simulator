function path_array = motion_model_base_trajectory_genarator_for_c2_09_07(acceleration,delta_middle,delta_finish,delta_start,x)
...
for i = 2:n+1
    ...
    abs_max_steer_angle = min([deg2rad(35),atan(0.9*abs_max_acceleration/(v(i)^2))]);%加速度値が1.0[m/s^2]を超えないような制限
    if i <= 1 + n/2  
